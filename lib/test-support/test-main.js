/* eslint-env node */
log.info('test-main called', process.argv);
...
log.info('test-main starting', indexUrl, testemUrl);
...
log.info('test-main parsed args', indexPath, indexQuery, emberAppDir, relPath);
...
app.on('ready', function onReady() {
  ...
  log.info('loading url in main window', indexPath, emberAppLocation);
